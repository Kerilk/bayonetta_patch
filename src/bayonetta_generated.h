...
typedef struct motLoadVectors_t motLoadVectors_t;
...
typedef
__cdecl
float bayoLoadMotRecord_func_t(motHeader_t * pMotHeader, motRecord_t * pMotRecord, void * * ppKeys, float date, int previousFrameIndex, int nextFrameIndex, int bInterpolate);
...
typedef
__stdcall
void * bayoFree_func_t(void * );

typedef
__cdecl
void * bayoAllocator_func_t(uint , uint , uint );
...
struct bayoMaterialVectorTable_t {
	bayoMaterialVectorTableItem_t * vectors[189];
};
...
struct motLoadVectors_t {
	bayoLoadMotRecord_func_t * pLoadFunctions[8];
};
...
struct bayoInstance_t {
	...
	dword field_30;
	dword field_34;
	bayoAllocator_func_t *pfAllocator;
	dword field_3C;
	dword field_40;
	dword field_44;
	dword field_48;
